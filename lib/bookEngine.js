...
const BookEngine = {
    ...
    initPageFlip() {
        ...
        // Book sizing:
        // - Desktop: 60% of viewport width for open book (two pages), 70% of height
        // - Mobile: 85% of viewport width for single page, 70% of height
        let pageWidth, pageHeight;

        if (isMobile) {
            // Single page view - page takes 85% of width, 70% of height
            pageWidth = vw * 0.85;
            pageHeight = vh * 0.70;
        } else {
            // Two-page view - each page is 30% of viewport width (60% total when open)
